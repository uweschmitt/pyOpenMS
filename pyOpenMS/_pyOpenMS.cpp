/* Generated by Cython 0.15.1 on Tue Oct 04 17:53:01 2011 */
...
static PyObject *__pyx_pf_9_pyOpenMS_10MSSpectrum_5setMSLevel(PyObject *__pyx_v_self, PyObject *__pyx_arg_a) {
  ...
  assert(__pyx_arg_a); {
    __pyx_v_a = __Pyx_PyInt_AsInt(__pyx_arg_a); if (unlikely((__pyx_v_a == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 324; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
