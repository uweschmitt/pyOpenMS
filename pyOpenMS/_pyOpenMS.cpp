/* Generated by Cython 0.15.1 on Wed Oct 05 17:31:35 2011 */
 ...
 */
  ((struct __pyx_obj_9_pyOpenMS_SourceFile *)__pyx_v_self)->inst->setFileSize(__pyx_v_a);
 ...
 */
  ((struct __pyx_obj_9_pyOpenMS_MSSpectrum *)__pyx_v_self)->inst->clear(__pyx_v_a);
 ...
 *     def size (self):
 */
  try {__pyx_t_1 = ((struct __pyx_obj_9_pyOpenMS_MSSpectrum *)__pyx_v_self)->inst->findNearest(__pyx_v_a);} catch(...) {__Pyx_CppExn2PyErr(); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 453; __pyx_clineno = __LINE__; goto __pyx_L1_error;}}
  __pyx_v__result = __pyx_t_1;
